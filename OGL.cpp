...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	while (pWindow->isRunning == FALSE)
	{
		...
		else
		{
			...
			glm::mat4 projection = glm::perspective(glm::radians(45.0f), (float)WindowManager::SCR_WIDTH / (float)WindowManager::SCR_HEIGHT, 1.0f, 100.0f);
			...
			shader.setFloat("time", static_cast<float>(Timer::getAppRunTime()));
